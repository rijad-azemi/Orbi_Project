...
namespace RestaurantAndDishes.Controllers
{
    public class DishesController : Controller
    {
        ...
        public DishesController(RestaurantAndDishesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Restaurant_Id")] Dish dish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Restaurant_Id")] Dish dish)
        {
            if (id != dish.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantAndDishesContext.Dishes'  is null.");
            }
            var dish = await _context.Dishes.FindAsync(id);
            if (dish != null)
            {
